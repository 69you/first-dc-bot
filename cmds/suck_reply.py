...
class respond(cog_all):
    ...
    async def on_message(self,msg):
        if msg.guild.id == 761900239572434954 or msg.guild.id == 944855324706344980: 
            pass
        else: 
            keyword1=["早安","早昂"]
            ...
            if msg.author.id == (int(jdata["yuusuke id"])) or msg.author.id == (int(jdata["piao id"])) or msg.author.id == (int(jdata["small piao id"])) or msg.author.id == (int(jdata["xing ye id"])) or msg.author.id == (int(jdata["death id"])) or msg.author.id == (int(jdata["fish id"]))  or msg.author.id == (int(jdata["daydream id"])):
            ...
            if msg.author.id == (int(jdata["xing ye id"])):
